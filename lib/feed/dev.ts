...
export function devSession(theme: Theme, title = "how a cache keeps a site alive"): SessionPublic {
  ...
  return {
    ...
    progress: { nodeIdx: 0, cardsInNode: 0, totalGenerated: SAMPLE_CARDS.length, exhausted: false, extensions: 0, lastIdx: null, epoch: 0, pendingReplan: false, awaitingChoice: false, deeperCards: 0 },
    clarifierAnswers: {},
  storyline: null,
    status: "active",
    error: null,
